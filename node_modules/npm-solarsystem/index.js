...
module.exports.getMars = function Mars() {
    const mars = {
        image: 'https://cdn.pixabay.com/photo/2011/12/13/14/30/mars-11012_1280.jpg',
...
module.exports.getJupiter = function Jupiter() {
    const jupiter = {
        image:'https://upload.wikimedia.org/wikipedia/commons/8/84/Hubble_Visible_View_of_Jupiter.jpg',
...
module.exports.getUranus = function Uranus() {
    const uranus = {
        image: 'https://wallpapers.com/images/hd/uranus-1908-x-1146-picture-ml36g1awgrs4fvf1.jpg',
...
module.exports.getPluto = function Pluto() {
    const pluto = {
        image: 'https://cdn.pixabay.com/photo/2021/09/03/06/33/pluto-6595130_1280.jpg',
